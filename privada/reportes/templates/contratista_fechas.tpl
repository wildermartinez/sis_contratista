...
<html lang="esp">
     <head>
          ...
          <script type="text/javascript">
            ...
            ventanaCalendario= window.open("contratista_fechas1.php?fecha1="+fecha1 + "&fecha2="+fecha2, "calendario","width=600, height=550,left=100,top=100,scrollbars=yes,menubars=no,statusbar=NO,status=NO,resizable=YES,location=NO")
            }
          </script>
     ...
     <body>
      <center>
        <br>
        <h1>REPORTES DE CONTRATISTA CON FECHAS DE INSERCION</h1>
