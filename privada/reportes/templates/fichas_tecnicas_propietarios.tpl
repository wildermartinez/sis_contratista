...
<html lang="esp">
     <head>
          ...
          function mostrar(id_propietario){
            ...
            //alert(id_propietario);
             ventanaCalendario= window.open("fichas_tecnicas_propietarios1.php?id_propietario=" +d1+"calendario","width=600, height=550,left=100,top=100,scrollbars=yes,menubars=no,statusbar=NO,status=NO,resizable=YES,location=NO")
          }
     ...
     <body>
       <!---------BUSCADOR-------->
       <center>
         <h1>FICHAS TECNICAS DE PROPIETARIOS</h1>
