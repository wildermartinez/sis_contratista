...
if (isset($_SESSION["sesion_id_rol"])){
	...
	if ($nick != ""){
		echo"<div id='header'>
				...
				if ($cuerp ==false) {
					echo "<a onclick='location.href=\"../claves/\"'><input type='button'name='accion' value='Cerrar Sesion' style='cursor:pointer;border-radius:10px;font-weigt:bold;height: 25px;' class='boton_cerrar'></a>";
				}
				else{
					echo "<a onclick='location.href=\"claves/\"'><input type='button'name='accion' value='Cerrar Sesion' style='cursor:pointer;border-radius:10px;font-weigt: bold;height: 25px;' class='boton_cerrar'></a>";
				}
